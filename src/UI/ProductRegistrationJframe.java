 ...
 * @author Hassan
 */
public class ProductRegistrationJframe extends javax.swing.JFrame {

    /**
     * Creates new form ProductRegistrationJframe
     */
    public ProductRegistrationJframe() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductRegistrationJframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductRegistrationJframe().setVisible(true);
            }
        });
    }
